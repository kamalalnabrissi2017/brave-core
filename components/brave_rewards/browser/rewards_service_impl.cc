...
const base::FilePath::StringType kPublisher_info_db2(L"publisher_info_db2"); // TODO remove me
...
const base::FilePath::StringType kPublisher_info_db2("publisher_info_db2"); // TODO remove me
