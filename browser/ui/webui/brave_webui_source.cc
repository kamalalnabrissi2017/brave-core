  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("rewards"), {
        ...
        { "transitionBannerRead", IDS_BRAVE_UI_TRANSITION_BANNER_READ },
        { "transitionBannerBody", IDS_BRAVE_UI_TRANSITION_BANNER_BODY },
        { "transitionBannerMore", IDS_BRAVE_UI_TRANSITION_BANNER_MORE },
        { "transitionBannerCTA", IDS_BRAVE_UI_TRANSITION_BANNER_CTA },
